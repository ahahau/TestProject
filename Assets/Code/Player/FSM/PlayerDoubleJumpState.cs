...
{
    public class PlayerDoubleJumpState : PlayerAirState, ICanAttackState, ICanDashState
    {
        public PlayerDoubleJumpState(Entity entity, AnimParamSO stateAnim) : base(entity, stateAnim)
        {
